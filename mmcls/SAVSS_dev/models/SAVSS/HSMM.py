...
from mmcls.SAVSS_dev.models.SAVSS.HSMM_layer import HSMM_layer
from models.GBC import BottConv


@BACKBONES.register_module()
class HSMM(BaseBackbone):
    arch_zoo = {
        'Crack': {
            'patch_size': 8,
            'embed_dims': 256,
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layers):
            ...
            if i in self.out_indices:
                ...
                patch_token = patch_token.permute(0, 3, 1, 2) # BCHW
